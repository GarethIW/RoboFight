...
namespace TiledLib
{
	...
	public class Map
	{
        ...
        /// <param name="layerName">The name of the layer to draw.</param>
        /// <param name="gameCamera">The camera to use for positioning.</param>
        public void DrawLayer(SpriteBatch spriteBatch, string layerName, Camera gameCamera, Color color, bool silhouette, float scale, Vector2 offset)
        {
            var l = GetLayer(layerName);
            ...
            if (tileLayer != null)
            {
                ...
                DrawLayer(spriteBatch, l, gameCamera, color, silhouette, scale, offset);
            }
        }
